...
<div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
    <div>
        <span class="text-primary font-bold text-xs uppercase tracking-widest">Manajemen Konten</span>
        <h1 class="text-4xl md:text-5xl font-extrabold font-headline text-on-surface leading-none tracking-tight mt-2 mb-3">Kelola Aspirasi</h1>
        <p class="text-on-surface-variant text-base max-w-2xl leading-relaxed">
            Tinjau, tanggapi, dan kurasi pengajuan komunitas untuk pengurus.
        </p>
    </div>
    @if($totalPending > 0)
...
<div class="bg-surface-container-lowest rounded-xl p-5 mb-8 shadow-sm flex flex-col md:flex-row gap-4 md:items-center justify-between">
    <form method="GET" action="{{ route('admin.aspirasi.index') }}" class="flex flex-wrap gap-4 items-center flex-1">
